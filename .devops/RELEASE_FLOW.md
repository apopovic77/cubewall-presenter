...
6. Validate the site at `https://cubewall.arkturian.com` (if applicable) and confirm fresh assets reached `/var/www/cubewall/site`.

## Rollback Strategy
- Use `.devops/rollback.sh` on the server to restore from `/var/backups/cubewall-*`.
